        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
           ...
           <div className="flex flex-col lg:flex-row justify-between items-center mb-12">
                <div className="w-full md:w-1/2 text-center md:text-left">
                    ...
                    Welcome to <b>"Grabzzy"</b> – your one-stop shop for trendy, affordable finds.
                    We bring you handpicked products that blend quality with style.
                    Fast delivery, secure checkout, and a smooth shopping experience – always.<br></br>
                    At Grabzzy, everything you love is just a click away!
                    </p>
                </div>
